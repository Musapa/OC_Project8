...
public class TestPerformance {
	...
	public void highVolumeTrackLocation() {
		...
		List<VisitedLocationDTO> locations = rewardsService.getUserLocation();
		stopWatch.stop();

		System.out.println("highVolumeTrackLocation: Number of locations visited: " + locations.size()
				+ " Time Elapsed: " + TimeUnit.MILLISECONDS.toSeconds(stopWatch.getTime()) + " seconds.");
